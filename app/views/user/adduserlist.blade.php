...
@section('content')
		...
		<div class="row">
			<div class="col-md-4">
				<h1>Add User</h1>
				<!--<form role="form" id="location_submit" method="post" action="{{ URL::route('searchLocation') }}">
				...
				<form role="form" id="location_submit" method="post" action="{{ URL::route('addUserPost') }}">
